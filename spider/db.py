...
class Connection(object):
  ...
  def _ensure_tables_exist(self):
    ...
    self.cursor.execute("CREATE TABLE IF NOT EXISTS author_translations (old integer PRIMARY KEY, new integer UNIQUE);")
    self.cursor.execute("CREATE TABLE IF NOT EXISTS articles_processed (done integer PRIMARY KEY);")
